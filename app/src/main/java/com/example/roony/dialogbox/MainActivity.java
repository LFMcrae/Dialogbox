package com.example.roony.dialogbox;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final View v2 = getLayoutInflater().inflate(R.layout.help, null);
        final View v1 = getLayoutInflater().inflate(R.layout.loginview, null);
        ...
        button2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                builder.setView(v2).setMessage("Select your hero,OKOK");
                builder.show();
            }
        });
